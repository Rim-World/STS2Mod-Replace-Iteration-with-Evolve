...
/// <summary>
/// 加载进化 Buff 图标（STS1 EvolvePower）。优先从模组 pck 读取；失败则回退 DLL 内嵌资源。
/// </summary>
public static class PowerIconTextureLoader
{
    ...
    private static void EnsureLoaded()
    {
        ...
        _initialized = true;
        _icon64 = Load(ModEntry.PowerIcon64Path, "EvolveReplacementMod.assets.evolve_power_64.png");
        _icon256 = Load(ModEntry.PowerIcon256Path, "EvolveReplacementMod.assets.evolve_power_256.png");
    }
